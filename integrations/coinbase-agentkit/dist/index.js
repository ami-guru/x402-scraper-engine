...
export { X402ScraperActionProvider } from "./x402ActionProvider.js";
import { X402ScraperActionProvider } from "./x402ActionProvider.js";
/**
 ...
 * ```
 */
export function x402ScraperActionProvider(config) {
    return new X402ScraperActionProvider(config);
}
