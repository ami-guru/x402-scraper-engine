import { ScrapeWebpageSchema, DigestWebpageSchema, AuditWebpageSchema, SearchWebSchema, SearchTwitterSchema, GetTwitterProfileSchema } from "./schemas.js";
...
export class X402ScraperActionProvider {
     ...
     */
    async executeWithPayment(path, body, walletProvider) {
